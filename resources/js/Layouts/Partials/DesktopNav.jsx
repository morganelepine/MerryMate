...
export default function DesktopNav({ unreadCount }) {
    return (
        <div className="hidden space-x-8 lg:-my-px lg:ml-10 lg:flex">
            <div className="hidden lg:flex lg:items-center">
                <Dropdown>
                    ...
                    <Dropdown.Content>
                        <Dropdown.Link href={route("lists.authLists")}>
                            Mes listes
                        </Dropdown.Link>
                        <Dropdown.Link href={route("lists.followedLists")}>
                            Mes listes suivies
                        </Dropdown.Link>
                    </Dropdown.Content>
                </Dropdown>
            ...
            <NavLink
                href={route("profile.gifts")}
                active={route().current("profile.gifts")}
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
